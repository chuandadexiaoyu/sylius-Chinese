    ...
    public function __construct(TranslatorInterface $translator)
    {
        ...
        if (version_compare(phpversion(), self::REQUIRED_PHP_VERSION, '>=')) {
            $this->add(new Requirement(
                ...
                in_array(date_default_timezone_set('America/New_York'), DateTimeZone::listIdentifiers()),
                $translator->trans('sylius.settings.non_deprecated', array(), 'requirements'),
                date_default_timezone_set('America/New_York'),
                true,
                $translator->trans('sylius.settings.timezone_deprecated.help', array('%timezone%' => date_default_timezone_set("Asia/Shanghai")), 'requirements')
            ));
        }
